<template>
  <div
    class="flex flex-col items-center justify-center bg-gray-50 min-h-screen p-6"
  >
...
export default {
  ...
  methods: {
    async success() {
      ...
      const url =
        "https://api.tosspayments.com/v1/payments/" + params.get("paymentKey");
