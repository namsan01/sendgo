<template>
  <div class="h-auto bg-[#f2f4f8] pb-[200px] md:h-auto">
    ...
    <div class="flex-col h-full items-center justify-center">
      <h2 class="text-3xl font-bold pt-[109px] mb-[18px] md:pt-[50px]">
        크레딧 구매
      </h2>
      <h2 class="mb-[53px]">
      ...
      <div class="w-full flex-center px-6">
        <div
          class="grid w-full md:px-0 max-w-[1460px] gap-6 grid-cols-4 md:grid-cols-1 xl:grid-cols-2 justify-items-center"
        >
          <div
          ...
          >
            ...
            <div class="w-full flex justify-between items-center">
              ...
              <h2
                class="flex-center items-center w-[70px] h-[33px] bg-[#E0EDFF] text-[#2116BF] font-semibold rounded-2xl text-[16px]"
              >
                +{{ product.bonus }}%
              </h2>
            </div>
            <div
              class="flex-col justify-between w-full h-[88px] bg-[#F4F5F6] rounded-lg p-4"
            >
            ...
            <button
              @click="pay('카드', product.price, product.order_id)"
              class="w-full h-[61px] bg-[#5146F0] rounded-lg text-xl text-white"
            >
              구매하기
            </button>
          </div>
