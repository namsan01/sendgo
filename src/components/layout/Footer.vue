<template>
  ...
  >
    <div class="footer w-[80rem] h-[9rem] xl:max-w-[60rem] lg:max-w-[40rem] md:max-w-full px-4" >
    ...
    <div class="flex-center w-full h-[10.8rem] border-gray-500 border-t">
      <div class=" w-[80rem] xl:max-w-[60rem] lg:max-w-[40rem] md:max-w-[30rem] text-sm p-4">
