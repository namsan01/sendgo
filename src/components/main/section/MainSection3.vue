  ...
  <div class="flex-col items-center w-full mt-[212px] mb-[249px] lg:mt-[142px] lg:mb-[199px] px-4">
    ...
    <div class="flex-col w-full gap-11 ">
      <div class="flex gap-11 lg:flex-col items-center">
        <div class="flex-col w-[50%] h-[597px] pt-[72px] pr-[54px] rounded-2xl bg-[#dceff4] gap-[60px] base:pr-0 lg:w-3/4 lg:px-[54px] items-center md:pt-[30px] md:h-[300px] md:w-full">
          <div>
        ...
        <div class="flex-col w-[50%] h-[597px] bg-[#FBFBEF] pt-[72px] pr-[54px] rounded-2xl gap-[60px] base:pr-0 lg:w-3/4 lg:px-[54px] items-center md:pt-[30px] md:h-[300px] md:w-full md:justify-around">
          <div>
      ...
      <div class="flex-col items-center justify-end gap-[49px] h-[495px] rounded-[25px] bg-[#f8f9fa] overflow-hidden  lg:justify-between lg:w-3/4 lg:text-[25px] lg:pt-[72px] lg:px-[54px] md:w-full md:h-[300px]">
