<template>
  <div class="flex w-full h-[995px] bg-black transition-all ease-in-out duration-300 base:h-[1280px] base:flex-col base:items-center overflow-hidden base:gap-20">
